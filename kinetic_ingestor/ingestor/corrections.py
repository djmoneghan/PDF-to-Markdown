...
def append_correction(
    record: dict[str, Any], config: dict[str, Any], project_dir: Path
) -> None:
    ...
    Args:
        ...
        project_dir: output directory for this document (processed/<source_id>/).
    """
    corrections_path = project_dir / Path(config["output"]["corrections_filename"]).name
...
def overwrite_correction(
    ...
    records = load_corrections(config, project_dir)
