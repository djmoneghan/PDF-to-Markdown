...
def export(
    ...
    AC-5.1 — atomic writes, output directory keyed by source_id.
    ...
    project_dir = processed_root / source_id
    ...
    _write_manifest(chunks, source_pdf_path, source_id, project_dir, config)
...
def _write_manifest(
    ...
    manifest = {
        ...
        "extraction_engine": chunks[0].extraction_engine,
        "chunk_count":       len(chunks),
        "chunks": [
            {
                "chunk_id":         chunk.chunk_id,
                "file":             f"{chunk.chunk_id}.md",
                "page_range":       chunk.page_range,
                "hitl_status":      chunk.hitl_status,
                "confidence_score": chunk.confidence_score,
            }
